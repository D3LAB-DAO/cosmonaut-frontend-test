...
import LogoLineShadow from "../../assets/images/logo-v4-line-shadow.svg";

const Container = tw.div`hidden navbar-menu relative z-50`;
const NavbarClose = tw.button``;
          ...
          <div class="block m-6 py-4 px-4 border-4 border-orange-400 h-full bg-white shadow rounded-xl">
            <div class="flex items-center mt-1 mb-6">
              <a class="mr-auto text-2xl font-bold leading-none" href="/">
                <img class="h-10" src={LogoLineShadow} alt="" width="auto" />
              </a>
              <NavbarClose class="navbar-close">
                <svg
